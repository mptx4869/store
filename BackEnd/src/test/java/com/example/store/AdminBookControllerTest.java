...
class AdminBookControllerTest {
        ...
        void setUp() {
                ...
                jdbcTemplate.update(
                                ...
                                LocalDate.of(2026, 1, 1), new BigDecimal("29.99"));
                ...
                Long testSkuId = jdbcTemplate.queryForObject("SELECT id FROM product_skus WHERE sku = 'TEST-001'",
                                Long.class);
        ...
        void shouldCreateBookWithSkus() {
                ...
                ResponseEntity<AdminBookResponse> response = restTemplate.exchange(requestEntity,
        ...
        void shouldRestoreSoftDeletedBook() {
                ...
                RequestEntity<Void> restoreRequest = RequestEntity
                                ...
                                .headers(headers)
                                .build();
                ResponseEntity<AdminBookResponse> restoreResponse = restTemplate.exchange(restoreRequest,
                                AdminBookResponse.class);
        ...
        void shouldUpdateBookImageUrl() {
                ...
                ResponseEntity<AdminBookResponse> response1 = restTemplate.exchange(requestEntity1,
                                AdminBookResponse.class);
                ...
                ResponseEntity<AdminBookResponse> response2 = restTemplate.exchange(requestEntity2,
                                AdminBookResponse.class);
        ...
        void shouldRemoveImageUrlWhenUpdatingToNull() {
                ...
                ResponseEntity<AdminBookResponse> response = restTemplate.exchange(requestEntity2,
                                AdminBookResponse.class);
        ...
        void shouldSetDefaultSku() {
                ...
                ResponseEntity<AdminBookResponse> response = restTemplate.exchange(setDefaultRequest,
                                AdminBookResponse.class);
        ...
        void shouldDeleteSku() {
                ...
                ResponseEntity<AdminBookResponse> response = restTemplate.exchange(deleteRequest,
                                AdminBookResponse.class);
