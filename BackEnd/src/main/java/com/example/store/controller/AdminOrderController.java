...
import com.example.store.service.AnalyticsService;
...
public class AdminOrderController {
    ...
    public ResponseEntity<List<RevenueResponse>> getRevenueAnalytics(
        ...
        List<RevenueResponse> analytics = analyticsService.getRevenueAnalytics(startDate, endDate, groupBy);
