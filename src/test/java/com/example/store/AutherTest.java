...
public class AutherTest {
	...
	void testRegisterNewUser(){
		RequestEntity<RegisterRequest> request = RequestEntity
			.post("/register")
			.body(new RegisterRequest("newUser", "newpassword","new`@gmail.com", 2));
    ...
    void testRegisterDuplicateUsernameOrEmail(){
        ...
        RequestEntity<RegisterRequest> request = RequestEntity
            .post("/register")
            .body(new RegisterRequest("nhanhoa", "newpassword","newuser@gmail.com",2));
        ...
        request = RequestEntity
            .post("/register")
            .body(new RegisterRequest("duplicateEmail", "newpassword","hoa@example.com",2));
    ...
    void testValidationEmptyRegister(){
        ...
        RequestEntity<RegisterRequest> request = RequestEntity
            .post("/register")
            .body(new RegisterRequest("", "newpassword","new@gmail.com",2));
        ...
        request = RequestEntity
            .post("/register")
            .body(new RegisterRequest("newUser", "","new@gmail.com",2));
        response = restTemplate.exchange(request, String.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.BAD_REQUEST);
        ...
        request = RequestEntity
            .post("/register")
            .body(new RegisterRequest("newUser", "newpassword","",2));
        response = restTemplate.exchange(request, String.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.BAD_REQUEST);
